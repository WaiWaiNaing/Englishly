...
export async function POST(request: Request) {
  ...
  // Image uploads go through POST /api/knowledge/extract-image first (one
  // request per file, client-side); by the time a document reaches here
  // it's always plain text, whether typed or extracted from screenshots.
  if (!title || !text) {
